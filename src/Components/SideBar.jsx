    ...
    <div className="w-full flex flex-col gap-2 font-sans text-sm">
      ...
      <div className="bg-[#1a1a1a] rounded-xl border border-gray-800 overflow-hidden shadow-sm">
        ...
        <div className="px-4 pb-4 flex flex-col items-start">
          ...
          <h2 className="text-lg font-bold text-white leading-tight">ธรวัชร ภูมิช่อ</h2>
          <p className="text-gray-400 mt-1 leading-normal">
            Aspiring VFX Artist with Background in Character FX | ...
          </p>
          <p className="text-gray-500 text-xs mt-2">กรุงเทพมหานคร, กรุงเทพมหานคร</p>
          
          <div className="flex items-center gap-2 mt-4">
            <img src="https://via.placeholder.com/24" className="rounded-sm" alt="company" />
            <span className="font-semibold text-gray-300">Riff Studio</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#1a1a1a] rounded-xl border border-gray-800 p-3 shadow-sm">
        <p className="text-gray-400 text-xs">สร้างความโดดเด่นต่อเจ้าหน้าที่สรรหาด้วยคุณลักษณะพิเศษและข้อมูลเชิงลึก</p>
